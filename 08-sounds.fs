...
VARIABLE sprite-image
CREATE sprite-rect SDL_Rect ALLOT
VARIABLE keystate
VARIABLE music
VARIABLE sdl-sound
VARIABLE forth-sound
...
: initialize-sdl ( -- )
    ...
    NULL SDL_GetKeyboardState keystate !
;
...
: load-media ( -- )
    ...
    renderer @ S" images/SDL-logo.png" >c-str IMG_LoadTexture sprite-image !
    sprite-image @ 0= IF
        ." Error creating texuture from file: " IMG_GeTerror c-str> TYPE CR
        game-cleanup
    THEN
    ...
    S" music/freesoftwaresong-8bit.ogg" >c-str Mix_LoadMUS music !
    music @ 0= IF
        ." Error loading music: " Mix_GetError c-str> TYPE CR
        game-cleanup
    THEN

    S" sounds/sdl1.ogg" >c-str Mix_LoadWAV sdl-sound !
    sdl-sound @ 0= IF
        ." Error loading sound effect: " Mix_GetError c-str> TYPE CR
        game-cleanup
    THEN

    S" sounds/forth2.ogg" >c-str Mix_LoadWAV forth-sound !
    forth-sound @ 0= IF
        ." Error loading sound effect: " Mix_GetError c-str> TYPE CR
        game-cleanup
    THEN
